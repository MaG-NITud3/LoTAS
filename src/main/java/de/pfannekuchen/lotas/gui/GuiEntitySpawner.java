...
public class GuiEntitySpawner extends GuiScreen {
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton)  {
		...
		e = entity.getEntity(mc.getIntegratedServer().worldServerForDimension(mc.thePlayer.dimension));
	...
	protected void actionPerformed(GuiButton button)  {
		...
		case 12:
			...
			break;
		case 69:
			Minecraft.getMinecraft().getIntegratedServer().worldServerForDimension(mc.thePlayer.dimension).spawnEntityInWorld(e);
		default:
			break;
		}
